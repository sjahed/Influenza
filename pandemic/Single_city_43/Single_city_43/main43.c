...
#define number_population_center 2 //# of population centers in the community
...
struct	bus business[12810];//CAUTION!!! It should have more spaces than the amount of businesses
...
float	uniform[21000]; // an array of random numbers
...
void main()
{
	...
	output3 = fopen("C:\\Users\\Barzan\\Desktop\\Single_city_43\\output_general_stats.txt","w");
	...
	while(t_now < 7*24) { // daily simulation begins ...   max_days
...
{
	input_constants = fopen("C:\\Users\\Barzan\\Desktop\\Single_city_43\\constants.txt","r");
...
{
	int i, j;
	input1 = fopen("C:\\Users\\Barzan\\Desktop\\Single_city_43\\households.txt","r");
	input2 = fopen("C:\\Users\\Barzan\\Desktop\\pandemic\\Single_city_43\\workplaces.txt","r");
	input3 = fopen("C:\\Users\\Barzan\\Desktop\\Single_city_43\\age_child.txt","r"); 
	input4 = fopen("C:\\Users\\Barzan\\Desktop\\Single_city_43\\age_adult.txt","r");
	input5 = fopen("C:\\Users\\Barzan\\Desktop\\Single_city_43\\zipcode.txt","r");
	input8 = fopen("C:\\Users\\Barzan\\Desktop\\Single_city_43\\gamma1.txt","r");
	input9 = fopen("C:\\Users\\Barzan\\Desktop\\Single_city_43\\gamma2.txt","r"); 
    input10 = fopen("C:\\Users\\Barzan\\Desktop\\Single_city_43\\lognorm1.txt","r");
	input11 = fopen("C:\\Users\\Barzan\\Desktop\\Single_city_43\\lognorm2.txt","r");
    input12 = fopen("C:\\Users\\Barzan\\Desktop\\Single_city_43\\weib1.txt","r");
	input13 = fopen("C:\\Users\\Barzan\\Desktop\\Single_city_43\\weib2.txt","r");
	output1 = fopen("C:\\Users\\Barzan\\Desktop\\Single_city_43\\output.txt","w");
	output2 = fopen("C:\\Users\\Barzan\\Desktop\\Single_city_43\\output_table_1.txt","w");
...
void  infection (int id, float k, int day, int infector, int contact_rate_hh, int contact_rate_wp, int contact_rate_er)// determine whether a person is infected or not
{
	...
	if (virus==1){
		...
		p = infection_probability (community[infector].rn_init_pandemic, community[infector].profile_pandemic, community[infector].infection_day_pandemic, contact_rate_hh, contact_rate_wp, contact_rate_er);
			printf("p=%f     %d\n",p,community[infector].infection_day_pandemic);
		}
		if (z==-1){
		z= uni(0,1);
		}
...
{   int aux, i;
	...
	output4 = fopen("C:\\Users\\Barzan\\Desktop\\Single_city_43\\output_R.txt","w");
