...
void main()
{
	...
	output3 = fopen("C:\\Diana_093010\\Single_city_43\\output_general_stats.txt","w");
	...
	while(t_now < max_days*24) { // daily simulation begins ...
...
{
	input_constants = fopen("C:\\Diana_093010\\Single_city_43\\constants.txt","r");
...
{
	int i, j;
	input1 = fopen("C:\\Diana_093010\\Single_city_43\\households.txt","r");
	input2 = fopen("C:\\Diana_093010\\Single_city_43\\workplaces.txt","r");
	input3 = fopen("C:\\Diana_093010\\Single_city_43\\age_child.txt","r"); 
	input4 = fopen("C:\\Diana_093010\\Single_city_43\\age_adult.txt","r");
	input5 = fopen("C:\\Diana_093010\\Single_city_43\\zipcode.txt","r");
	input8 = fopen("C:\\Diana_093010\\Single_city_43\\gamma1.txt","r");
	input9 = fopen("C:\\Diana_093010\\Single_city_43\\gamma2.txt","r"); 
    input10 = fopen("C:\\Diana_093010\\Single_city_43\\lognorm1.txt","r");
	input11 = fopen("C:\\Diana_093010\\Single_city_43\\lognorm2.txt","r");
    input12 = fopen("C:\\Diana_093010\\Single_city_43\\weib1.txt","r");
	input13 = fopen("C:\\Diana_093010\\Single_city_43\\weib2.txt","r");
	output1 = fopen("C:\\Diana_093010\\Single_city_43\\output.txt","w");
	output2 = fopen("C:\\Diana_093010\\Single_city_43\\output_table_1.txt","w");
...
{   int aux, i;
	...
	output4 = fopen("C:\\Diana_093010\\Single_city_43\\output_R.txt","w");
